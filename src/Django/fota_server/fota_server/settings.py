"""
Django settings for fota_server project.
...
SECRET_KEY = 'django-insecure-k&m#4wx0g62sfvl4olops-lphs*#sij=q+#wyv%rof)ikwr7)7'
...
WSGI_APPLICATION = 'fota_server.wsgi.application'
